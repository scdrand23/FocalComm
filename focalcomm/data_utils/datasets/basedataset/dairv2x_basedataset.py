...
import random
import focalcomm.utils.pcd_utils as pcd_utils
...
from focalcomm.utils.pcd_utils import downsample_lidar_minimum
from focalcomm.utils.camera_utils import load_camera_data, load_intrinsic_DAIR_V2X
from focalcomm.utils.common_utils import read_json
from focalcomm.utils.transformation_utils import tfm_to_pose, rot_and_trans_to_trasnformation_matrix
from focalcomm.utils.transformation_utils import veh_side_rot_and_trans_to_trasnformation_matrix
from focalcomm.utils.transformation_utils import inf_side_rot_and_trans_to_trasnformation_matrix
from focalcomm.data_utils.pre_processor import build_preprocessor
from focalcomm.data_utils.post_processor import build_postprocessor
...
class DAIRV2XBaseDataset(Dataset):
    def __init__(self, params, visualize, train=True):
        ...
        # if hasattr(self.post_processor, 'generate_gt_bbx_by_iou'):
