# -*- coding: utf-8 -*-
# Based on opencood/data_utils/datasets/basedataset.py written by Runsheng Xu 
# and UCLA Mobility Lab https://github.com/ucla-mobility/V2X-Real
# Edit by: Dereje Shenkut <derejeshenkut@gmail.com>
...
from focalcomm.data_utils import SUPER_CLASS_MAP
...
class V2XRealBaseDataset(Dataset):
    ...
    pre_processor : focalcomm.pre_processor
        Used to preprocess the raw data.

    post_processor : focalcomm.post_processor
        Used to generate training labels and convert the model outputs to
        bbx formats.

    data_augmentor : focalcomm.data_augmentor
