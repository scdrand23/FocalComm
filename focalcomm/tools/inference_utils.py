...
from focalcomm.utils.common_utils import torch_tensor_to_numpy
# from focalcomm.loss.focalcommv2_loss import FocalCommV2Loss
...
def inference_early_fusion(batch_data, model, dataset):
    ...
    # pred_box_tensor, pred_score = FocalCommV2Loss.convert_to_inference_format(
    #     output_dict['ego'],
    #     model.loss.args  # Access the args directly from the model's loss module
    # )
    # breakpoint()
    pred_box_tensor, pred_score, gt_box_tensor, gt_label_tensor = \
        dataset.post_process(batch_data,
