...
def main():
    ...
    # optimizer setup
    optimizer, onecycle_scheduler = train_utils.setup_optimizer(hypes, model_without_ddp)
    # lr scheduler setup
    scheduler = onecycle_scheduler if onecycle_scheduler is not None else \
               train_utils.setup_lr_schedular(hypes, optimizer)
